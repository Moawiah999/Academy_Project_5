...
const updateReservation = (req, res) => {
  ...
  db.query(
    "UPDATE reservation SET hotel_id = COALESCE($1,hotel_id) , flight_id = COALESCE($2,flight_id) , tour_package_id = COALESCE($3,tour_package_id) WHERE user_id = $4",
    [hotel_id, flight_id, tour_package_id, user_id]
  );
};
module.exports = { getReservationsById, reservation, updateReservation };
